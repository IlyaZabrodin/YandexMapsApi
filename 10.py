...
class WorkMap(QMainWindow):
    ...
    def initUI(self):
        ...
        self.postaddress_checkBox.stateChanged.connect(self.updatesearch)
    ...
    def search(self):
        ...
        if response:
            ...
            if self.postaddress_checkBox.isChecked() == True:
                try:
                    toponym_post_code = \
                    ...
                    toponym_post_code = ""
                self.address.setText(toponym_as + ", " + toponym_post_code)
            else:
